...
namespace Bombones.IoC
{
    public static class DI
    {
        public static IServiceProvider ConfigurarServicios()
        {
            ...
            service.AddScoped<IRepositorioMails, RepositorioMails>();
            service.AddScoped<IRepositorioProveedoresMails, RepositorioProveedoresMails>();
            service.AddScoped<IRepositorioTelefonos, RepositorioTelefonos>();
            service.AddScoped<IRepositorioProveedoresTelefonos, RepositorioProveedoresTelefonos>();
            ...
            service.AddScoped<IServiciosProveedores>(sp =>
            {
                ...
                var repositorioMails = new RepositorioMails();
                var repositorioTelefonos = new RepositorioTelefonos();
                var repositorioProveedoresTelefonos = new RepositorioProveedoresTelefonos();
                var repositorioProveedoresMails = new RepositorioProveedoresMails();
                return new ServiciosProveedores(repositorio, repositorioMails,
                    repositorioTelefonos, repositorioProveedoresMails, repositorioProveedoresTelefonos, cadena);
            });
